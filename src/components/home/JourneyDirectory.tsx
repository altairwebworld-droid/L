  ...
  return <section className="relative border-y border-white/10 px-6 py-16 md:py-24" aria-labelledby="journey-title">
    <div className="mx-auto max-w-7xl">
      <div className="grid gap-8 lg:grid-cols-[.75fr_1.25fr] lg:items-end">
        <div><p className="micro-label text-ink-muted">Where customers slip away</p><h2 id="journey-title" className="section-title mt-5">Find where the customer slips away.</h2></div>
        <p className="max-w-2xl text-lg font-light leading-relaxed text-ink-muted">Customers slip away at four moments: before they call, when nobody picks up, after you send an estimate, and after the job is done. Pick the one costing you most and we start there.</p>
      </div>

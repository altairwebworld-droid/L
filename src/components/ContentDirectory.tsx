...
export default function ContentDirectory({ pages, title, description }: { pages: PageMeta[]; title: string; description: string }) {
  ...
  return <div className="directory-page">
    <header className="directory-intro"><p className="micro-label">LYCORE GROUP LLC</p><h1>{title}</h1><p>{description}</p><Link to="/contact" className="btn-primary" data-track="free_audit_click">Get a free growth system audit</Link></header>

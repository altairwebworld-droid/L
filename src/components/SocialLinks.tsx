...
const socialProfiles = [
  ...
  { href: site.socials.whatsapp, label: 'Message LYCORE GROUP on WhatsApp', Icon: FaWhatsapp, imageSrc: null, brandClass: 'border-[#25D366] bg-[#25D366] text-white hover:border-[#45e17d] hover:bg-[#20bd5a]' },
];
...
export function WhatsAppLink({ className = '' }: { className?: string }) {
  return (
    ...
    >
      ...
      <span>Message LYCORE GROUP on WhatsApp</span>
    </a>
  );
}

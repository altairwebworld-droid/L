...
const privacySections: PolicySection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      'The contact form offers two independent, optional, unchecked SMS choices. If you select the marketing checkbox, you agree to receive marketing text messages from LYCORE GROUP LLC (LYCORE) about its services, offers, and updates. Message frequency varies and message and data rates may apply. If you select the verification checkbox, you agree to receive a one-time account or identity verification code by text only when you request one; message frequency is as requested and message and data rates may apply. Verification-code consent does not enroll you in marketing messages.',
      'Neither SMS choice is required to submit a request or use the website. Each choice applies only to the specific message purpose described beside that checkbox. Reply STOP to opt out or HELP for help. After opting out, LYCORE will not send further messages through that program unless you provide a new valid opt-in, subject to carrier processing.',
      'No mobile information will be sold or shared with third parties for promotional or marketing purposes. Mobile numbers and SMS consent records are not shared with third parties or affiliates for their own marketing. Messaging providers may process mobile information only as service providers as needed to deliver requested messages. We retain consent records, including the consent choice, form source, and time, as needed to demonstrate consent and manage opt-outs.',
    ],
  },
  {
...
const termsSections: PolicySection[] = [
  {
    title: 'SMS Terms',
    paragraphs: ['The contact form presents separate, optional, unchecked SMS choices. Selecting the marketing choice authorizes LYCORE GROUP LLC (LYCORE) to send marketing text messages about LYCORE services, offers, and updates. Message frequency varies; message and data rates may apply. Selecting the verification choice authorizes LYCORE to send a one-time account or identity verification code only when you request one. Message frequency is as requested; message and data rates may apply. Verification-code consent is not marketing consent. Neither choice is required to submit a request.', 'Reply STOP to opt out or HELP for help. You may also contact services@lycore.org. Carriers are not liable for delayed or undelivered messages. LYCORE uses messaging providers as service providers to deliver requested messages. No mobile information will be sold or shared with third parties for promotional or marketing purposes, and mobile information or SMS consent records will not be shared for third-party marketing.'],
  },
  {

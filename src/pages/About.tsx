...
=======
          ...
          >
            We build the <i className="text-gradient">digital backbone</i> of the bail industry.
>>>>>>> origin/main
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
...
=======
            <div className="p-10 h-full glass-panel rounded-3xl border border-white/10">
              <h3 className="text-2xl font-display font-medium mb-6">Our Mission</h3>
              <p className="text-stone-400 font-light leading-relaxed">
                To empower specialized agencies with automated systems that capture every lead, reduce operational risk, and dominate their local markets. We don't just build websites; we build profit-driving engines.
>>>>>>> origin/main
              </p>
            </div>
          </TiltCard>
          <TiltCard>
            <div className="p-10 h-full bg-white/5 rounded-3xl border border-white/5">
...
=======
        ...
        <div className="mb-32">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-display font-medium mb-4">Core Principles</h2>
            <p className="text-stone-400 font-light">The values that drive every line of code we write.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              {
                icon: <Shield className="text-white/60" size={32} />,
                title: "Reliability",
                desc: "In bail, a minute of downtime is a lost client. Our systems are built for 100% mission-critical uptime."
              },
              {
                icon: <Target className="text-white/60" size={32} />,
                title: "Precision",
                desc: "We focus on the data that matters. No fluff, just high-converting intake and qualification."
              },
              {
                icon: <Award className="text-white/60" size={32} />,
                title: "Excellence",
                desc: "Every interaction, from a mobile tap to an AI chat, must feel premium and professional."
              }
            ].map((value, i) => (
              <div key={i} className="text-center flex flex-col items-center">
                <div className="mb-6">{value.icon}</div>
                <h4 className="text-xl font-display font-medium mb-4">{value.title}</h4>

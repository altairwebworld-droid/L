...
function fallbackFor(page: PageMeta) {
  ...
  const smsConsentContent = page.path === '/contact' ? `<section id="sms-consent"><h2>Optional SMS consent</h2><p>Yes, send me recurring automated SMS messages from LYCORE about my request, scheduling and service updates. Message frequency varies, up to 5 messages per month. Message and data rates may apply. Reply STOP to opt out or HELP for help. Consent is optional and not required to submit this form. <a href="/terms#sms">SMS Terms</a> and <a href="/privacy-policy#sms">Privacy Policy</a>.</p><p>Marketing email consent is separate and optional.</p></section>` : '';
